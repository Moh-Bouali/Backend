...
import com.s3.individual.s3individual.Business.exception.InvalidAccessTokenException;
...
public class AccessTokenEncoderDecoderImpl implements AccessTokenEncoder, AccessTokenDecoder {
    ...
    public String encode(AccessToken accessToken) {
        ...
        if (accessToken.getPersonId() != null) {
            claimsMap.put("personId", accessToken.getPersonId());
        }
    ...
    public AccessToken decode(String accessTokenEncoded) {
        try {
            ...
            return AccessToken.builder()
                    ...
                    .roles(roles)
                    .personId(claims.get("personId", Long.class))
                    .build();
