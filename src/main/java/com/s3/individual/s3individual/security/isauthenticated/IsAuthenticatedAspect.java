package com.s3.individual.s3individual.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(com.s3.individual.s3individual.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(com.s3.individual.s3individual.security.isauthenticated.IsAuthenticated)")
